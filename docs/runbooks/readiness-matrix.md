...
| SC-002 | P95 end-to-end analysis ≤ 8 min | `k6-nightly` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25782810554 |
...
| SC-006 | PACS C-STORE success rate ≥ 95% (staging) | `k6-nightly` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25782810554 |

...
|---|---|---|---|---|
| SC-001 | Segmentation Dice ≥ 0.85 on AMOS22 mini | `ci-ml-regression` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953362 |
| SC-002 | P95 end-to-end analysis ≤ 8 min | `k6-nightly` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25842282390 |
| SC-003 | Classification abstention rate ≤ 20% on validation | `ci-ml-regression` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953362 |
| SC-004 | Audit chain verifier 100% pass over 24 h | `ci-fhir-integration` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953362 |
| SC-005 | PHI scrubber fail-closed on all synthetic injections | `ci-rbac-red-team` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953362 |
| SC-006 | PACS C-STORE success rate ≥ 95% (staging) | `k6-nightly` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25842282390 |
| SC-007 | DICOM UID root configured | `ci-dicom-uid-present` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953362 |
| SC-008 | RUO watermark present on all exports | `e2e-cpu` (us6-ruo-watermark) | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953321 |
| SC-009 | Multi-tenant isolation (no cross-tenant reads) | `ci-rbac-red-team` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953362 |
| SC-010 | Erasure within 30-day SLA | `e2e-cpu` (us10-erasure-request) | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953321 |
| SC-011 | Crypto-shred within 60 s | `e2e-cpu` (us10-crypto-shred-within-60s) | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953321 |
...
| SC-013 | Viewer FPS ≥ 30 on 512³ reference volume | `ci-viewer-fps` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953362 |
| SC-014 | Lighthouse web-vitals budget | `ci-lighthouse` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953362 |
| SC-015 | Bundle budget (≤ 350 KB gzip initial) | `ci-bundle-check` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953362 |
| SC-016 | License compliance (Apache-2.0 only) | `ci-license-check` | :x: red | https://github.com/MediMindAI/LiverRa/actions/runs/25694953362 |

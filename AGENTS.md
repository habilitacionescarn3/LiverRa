...
This file provides guidance to Codex when working in the LiverRa repository.
...
├── .Codex/              # Codex config (agents, skills, commands)
...
Comprehensive research was completed BEFORE this scaffold was built. Consolidated findings live in `docs/research/`. Every Codex session in this repo should treat these as authoritative context for the product, technical, regulatory, and commercial strategy.
